...
export function loadDiscussions(id) {
  const recentDiscussionsQuery = query(collection(getFirestore(), 'commonData'), where("users", "array-contains", id), orderBy('timestamp', 'desc'));
