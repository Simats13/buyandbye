    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <img class="rounded float-left" height=150
          src="https://firebasestorage.googleapis.com/v0/b/oficium-11bf9.appspot.com/o/assets%2Ficon_white.png?alt=media&token=5e528de6-1a7d-44fd-a912-1cee743fe107"
          alt="">
      </a>
