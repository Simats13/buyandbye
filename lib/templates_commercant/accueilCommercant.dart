...
import 'package:oficihome/templates_commercant/newProduct.dart';
                  ...
                  itemBuilder: (context, index) {
                    return SingleChildScrollView(
                      // Appel de la fonction pour chaque catégorie
                        child: Categorie(
                            snapshot, listOfCategories, index, widget.uid));
                  },
                ),
              ],
            );
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => DetailProduit(
                                    widget.snapshot.data.docs[index2]["nom"],
                                    widget.snapshot.data.docs[index2]["prix"],
                                    ...
                                    widget.snapshot.data.docs[index2]
                                        ["quantite"],
                                    widget.uid,
                                    widget.snapshot.data.docs[index2]["id"],
                                    widget.snapshot.data.docs[index2]
                                        ["categorie"],
                                    widget.snapshot.data.docs[index2]
                                        ["visible"],
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Image.network(widget
                                      .snapshot.data.docs[index2]["images"][0]),
                                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    widget.snapshot.data.docs[index2]["visible"]
                                        ? SizedBox.shrink()
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(widget
                                            .snapshot.data.docs[index2]["prix"]
                                            .toStringAsFixed(2) +
                                        "€"),
                                    SizedBox(height: 30),
                                    Text("Quantité : " +
