...
class _DetailProduitState extends State<DetailProduit> {
  ...
  Widget build(BuildContext context) {
    String dropdownValue = widget.categorie;
    var carouselList =
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text("Référence : " + widget.reference.toString()),
                        SizedBox(height: 20),
                        Text("Description : " + widget.desc),
                        SizedBox(height: 20),
                        Text("Prix : " + widget.prix.toStringAsFixed(2) + "€"),
                        SizedBox(height: 20),
                        Text("Restant : " + widget.quantite.toString()),
                        SizedBox(height: 20),
