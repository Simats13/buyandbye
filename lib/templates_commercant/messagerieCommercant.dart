...
import 'package:oficihome/templates/Messagerie/Controllers/utils.dart';
import 'package:oficihome/templates/Messagerie/subWidgets/common_widgets.dart';
import 'package:oficihome/templates/Messagerie/subWidgets/local_notification_view.dart';
                    ...
                    children: [
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ChatRoomListTile("lastMessage", "chatRoomId",
                              "myUsername", "nameOther");
                        },
                      ),
                      Center(
                          child: Text("Page en cours de réparation",
