    ...
    if (messageTextEdittingController.text != "") {
      ...
      DatabaseMethods()
        ...
        NotificationController.instance
            .sendNotificationMessage(message, myUserName, widget.token);
        ...
        Flexible(
          child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                    color: sendByMe
                        ? OficihomeAppTheme.white
                        : OficihomeAppTheme.black_electrik),
              )),
        ),
      ],
    );
                  ...
                  children: [
                    Expanded(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                              color: OficihomeAppTheme.white.withOpacity(0.6))),
                    )),
                    GestureDetector(
                      child: Icon(
                        Icons.send,
