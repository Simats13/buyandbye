...
class _PageDetail extends State<PageDetail> with LocalNotificationView {
  ...
  String? myID, selectedUserToken, geohash, menuDropDownValue, dropdownValue;
  double latitude = 0.0;
            ...
            PreferredSize(
              ...
              child: CupertinoSliverNavigationBarDetail(
                ...
                leading: IconButton(
                  ...
                  onPressed: () async {
                    checkFavoriteShop = await DatabaseMethods().checkFavoriteShopSeller(widget.sellerID);
                  ...
                  children: [
                    loved
                        ? IconButton(
                            ...
                            onPressed: () async {
                              await DatabaseMethods().addFavoriteShop(myID!, widget.sellerID, true, geohash, latitude, longitude);
                              setState(() {
                                loved = !loved;
                              });
                              StatusAlert.show(
                        ...
                        : IconButton(
                            ...
                            onPressed: () async {
                              await DatabaseMethods().addFavoriteShop(myID, widget.sellerID, false, geohash, latitude, longitude);
                              setState(() {
                                loved = !loved;
                              });
                              StatusAlert.show(
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) => ChatRoom(
                                                ...
                                                "${snapshot.data["fname"]} ${snapshot.data["lname"]}", // NOM DE L'UTILISATEUR
                                                selectedUserToken,
                                                ...
                                                snapshot.data['imgUrl'], // IMAGE DE L'UTILISATEUR
                                                "client")));
                                  },
                                  child: Icon(
                                    Icons.message,
