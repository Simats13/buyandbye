              ...
              child: Container(
                ...
                child: Column(
                  children: [
                              ...
                              children: [
                                                ...
                                                try {
                                                  ...
                                                  if (e
                                                    ...
                                                    if (e.code ==
                                                      ...
                                                      showMessage(
                                                          "Impossible de lier ce mode d'authentification",
                                                          erreur);
                                                    }
                                                  }
                                                }
                                ...
                                myID != ""
                                    ? StreamBuilder<dynamic>(
                                        stream:
                                            ProviderGetAddresses().returnData(),
                                        builder: (context, snapshot) {
                                          if (snapshot.hasData) {
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return paymentIntentData != null
                                                  ? Column(
                                                      children: [
                                                        ListTile(
                                                          leading: paymentIntentData!['paymentMethods']['data']
                                                                              [
                                                                              index]
                                                                          [
                                                                          'card']
                                                                        ...
                                                                        MaterialPageRoute(
                                                                          builder: (context) =>
                                                                            ...
                                                                            customerID:
                                                                                customerID,
                                                                            idCard:
                                                                                paymentIntentData!['paymentMethods']['data'][index]['id'],
                                                                            expYear:
                                                                  ...
                                                                  BottomSheetAction(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        for (var i =
                                                                            ...
                                                                            i++) {
                                                                          if (paymentIntentData!['paymentMethods']['data'][i] ==
                                                                              id) {}
                                                                        }
                                                                        List
                                                                            data =
                    ...
                    Visibility(
                        visible: !isVisible,
                        child: ModifyProfile(myFirstName!, myLastName!,
                            myEmail!, myPhone!, myID!))
                  ],
                ),
                // ),
              ),
