...
const double _kNavBarLargeTitleHeightExtension = 10.0;
...
class CupertinoNavigationBarDetail extends StatefulWidget implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const CupertinoNavigationBarDetail({
    Key? key,
    this.leading,
  ...
  @override
  State<CupertinoNavigationBarDetail> createState() => _CupertinoNavigationBarDetailState();
}
...
class _CupertinoNavigationBarDetailState extends State<CupertinoNavigationBarDetail> {
...
///    pages.
class CupertinoSliverNavigationBarDetail extends StatefulWidget {
  /// Creates a navigation bar for scrolling lists.
  ///
  /// The [largeTitle] argument is required and must not be null.
  const CupertinoSliverNavigationBarDetail({
    Key? key,
    this.largeTitle,
    this.leading,
    this.automaticallyImplyLeading = true,
  ...
  @override
  State<CupertinoSliverNavigationBarDetail> createState() => _CupertinoSliverNavigationBarDetailState();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _CupertinoSliverNavigationBarDetailState extends State<CupertinoSliverNavigationBarDetail> {
  late _NavigationBarStaticComponentsKeys keys;
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading == null && backChevron != null && backLabel != null) {
      leading = CupertinoNavigationBarBackButtonDetail._assemble(
        backChevron,
        backLabel,
      );
    }
...
class CupertinoNavigationBarBackButtonDetail extends StatelessWidget {
  /// Construct a [CupertinoNavigationBarBackButton] that can be used to pop
  /// the current route.
  ///
  /// The [color] parameter must not be null.
  const CupertinoNavigationBarBackButtonDetail({
    Key? key,
    this.color,
    this.previousPageTitle,
    this.onPressed,
  ...
  const CupertinoNavigationBarBackButtonDetail._assemble(
    this._backChevron,
    this._backLabel,
