    ...
    Platform.isIOS
        ? showCupertinoDialog(
            ...
            builder: (context) => CupertinoAlertDialog(
              ...
              content: const Text(
                  "Le paiement a été annulé, souhaitez-vous réssayer ?"),
              actions: [
                // Close the dialog
                CupertinoButton(
                    child: const Text('Non'),
  ...
  payViaNewCard(BuildContext context) async {
    ...
    try {
      ...
      for (int i = 0; i < querySnapshot.docs.length; i++) {
        num totalPerProduct = querySnapshot.docs[i]['prixProduit'] *
            querySnapshot.docs[i]['amount'];
