    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data">
                    <h3>Informations personnelles <a data-toggle="tooltip" data-bs-placement="right"
                            title="Informations personnelles de la personne propriétaire de l'entreprise, elles n'apparaîtront pas sur l'application mobile">ⓘ</a>
                    </h3>
                    ...
                    <div class="form-group form-row">
                        <div class="col">
                            ...
                            <input type="text" name="ownerLastName" id="lastname" class="form-control" placeholder="ex: Dupont"
                                size="40" value="<?=$document['lname']?>" required>
                        </div>
                        <div class="col">
                            <label for="firstname">Prénom</label>
                            <input type="text" name="ownerFirstName" id="firstname" class="form-control" placeholder="ex: Frédéric"
                                size="40" value="<?=$document['fname']?>" required>
                        </div>
                    </div>



                    <h3>Informations de l'entreprise <a data-toggle="tooltip" data-bs-placement="right"
                            title="Toutes ces informations présentes ci-dessous sont affichées sur l'application mobile">ⓘ</a></h3>


                    <div class="form-group form-row">
                        <div class="col">
                            <label for="exampleFormControlInput1">Nom de l'entreprise</label>
                            <input type="text" name="companyName" class="form-control" id="exampleFormControlInput1" size="40"
                                placeholder="Dupont SAS" value="<?=$document['name']?>" required>
                        </div>
                        <div class="col">
                            <label for="autocomplete"> Adresse de l'entreprise </label>
                            <input type="text" name="autocomplete" id="autocomplete_<?=$document->id()?>" class="form-control"
                                size="40" placeholder="Avenue des Champs-Elysée, Paris" value="<?=$document['adresse']?>" required>
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col">
                            ...
                            <input type="tel" id="phone" class="form-control" name="phone" size="40" value="<?=$document['phone']?>"
                    ...
                    <div class="form-group form-row">
                        ...
                        <select value="" class="custom-select mr-sm-2 companyType" id="companyType" name="companyType">
                            <option value="Magasin" <?php if($document['type'] == "Magasin" ) echo 'selected="selected"';?>>Magasin
                            </option>
                            <option value="Service" <?php if($document['type'] == "Service" ) echo 'selected="selected"';?>>Service
                            </option>
                            <option value="Restaurant" <?php if($document['type'] == "Restaurant" ) echo 'selected="selected"';?>>
                                Restaurant</option>
                    ...
                    <div class="form-group form-row category1">
                        ...
                        <div class="color-2">
                            <select data-placeholder="Tags Magasin" name="select[]" id="select1" multiple class="chosen-select"
                                tabindex="8">
                                <option
                    ...
                    <div class="form-group form-row category2">
                        <div class="color-2">
                            <select data-placeholder="Tags Service" name="select[]" id="select2" multiple class="chosen-select"
                                tabindex="8">
                                <option
                                    <?php foreach ($document['mainCategorie'] as $selection) { if($selection == "Menuiserie") echo 'selected="selected"';} ?>>
                                    Menuiserie</option>
                    ...
                    <div class="form-group form-row category3">
                        <div class="color-2">
                            <select data-placeholder="Tags Restaurant" name="select[]" id="select3" multiple class="chosen-select"
                                tabindex="8">
                                <option
                    ...
                    <div class="form-group form-row category4">
                        <div class="color-2">
                            <select data-placeholder="Tags Santé" name="select[]" id="select4" multiple class="chosen-select"
                                tabindex="8">
                                <option
                    ...
                    <div class="form-group form-row category5">
                        <div class="color-2">
                            <select data-placeholder="Tags Culture et loisirs" name="select[]" id="select5" multiple
                        ...
                        <div class="form-group col">
                            <div class="form-group col-md-2">
                                ...
                                <input type="color" class="form-control form-control-color" name="color" id="exampleColorInput"
                                    style="width:50px; height:50px" value="#<?=$document['colorStore']?>"
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="isPhoneVisible" id="isphonevisible"
                                    <?php if($document['isPhoneVisible'] == true) { echo "checked";}?>>
                                <label class="form-check-label" for="isPhoneVisible">Afficher le numéro de téléphone aux clients <a
                                        data-toggle="tooltip" data-bs-placement="right"
                                        title="Permet d'afficher aux clients le numéro de téléphone sur l'application">ⓘ</a></label>
                            </div>
                            </td>
                            <td></td>
                            <td></td>
                            ...
                            <tr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select value="" class="custom-select mr-sm-2 companyType_<?=$count?>"
                                            ...
                                            <option value="Restaurant"
                                                ...
                                                Restaurant</option>
                                            <option value="Santé"
                                                <?php if($document['type'] == "Santé" ) echo 'selected="selected"';?>>
                                                Santé
                                            </option>
                                            <option value="Culture & Loisirs"
                                                <?php if($document['type'] == "Culture & Loisirs" ) echo 'selected="selected"';?>>
                                ...
                                <td>
                                    ...
                                    <div class="category4_<?=$count?>">
                                        <div class="form-group">
                                            <div class="color-2">
                                                <select data-placeholder="Tags Santé" name="select[]" id="select4_<?=$count?>"
                                                    multiple class="chosen-select" tabindex="8">
                                                    <option
                                                        <?php foreach ($document['mainCategorie'] as $selection) { if($selection == "Pharmacie") echo 'selected="selected"';} ?>>
                                                        Pharmacie</option>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group ">
                                        ...
                                        <input type="color" class="form-control form-control-color" name="color"
                                            id="exampleColorInput" style="width:50px" value="#<?=$document['colorStore']?>"
                                            title="Choissisez une couleur">
                                    </div>
                                </td>
                                <td></td>
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" name="livraison" type="checkbox" value=""
                                                id="defaultCheck1" <?php if($document['livraison'] == true) { echo "checked";}?>>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="form-group">
                                        ...
                                        <img id="old_banniere" src="<?=$document['imgUrl']?>" class="img-thumbnail img-fluid"
                                            alt="<?=$document['imgUrl']?>" style="max-width:600px; width:100%">
